...
推荐运行：
python cnn_90_10_train_predict.py --data_root "D:/TM_CNN_100" --layout simple --max_samples 100 --train_ratio 0.9 --epochs 30 --batch_size 2 --img_size 256
...
def parse_args():
    ...
    parser.add_argument("--data_root", type=str, required=True,
                        help="数据根目录。简单结构：里面包含 original 和 label；原数据集结构：里面包含 Colour1/Original, Colour1/Label 等")
    parser.add_argument("--layout", type=str, default="auto", choices=["auto", "simple", "dataset"],
